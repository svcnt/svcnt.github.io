...
module.exports = function (info) {
    ...
    return {
        height: '1cm',
        contents: '<div style="float:left;">Página {{page}}/{{pages}}</div><div style="float:right;">&copy; Copyleft ' + dateFormat() + ' transcripción de José Vicente Araújo basada en tutorial deDaniel Shiffman</div>'
    };
};
